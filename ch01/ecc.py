...
class S256Point(Point):
    ...
    def parse(self, sec_bin):
        if sec_bin[0] == 4:
            x = S256Field.from_bytes(sec_bin[1:33])
            y = S256Field.from_bytes(sec_bin[33:65])
